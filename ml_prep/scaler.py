# print(list(zip([[12, 25, 37], [15, 27, 39], [16, 30, 45]])))
class DataScaler:
    # fit() 함수에서 최소값, 최대값을 구하기 위해
    # 최소값, 최대값 초기화 작업을 먼저 진행(변수를 선언)
    def __init__(self):
        self.min = None # 숫자 0을 넣어도 무관
        self.max = None # 숫자 0을 넣어도 무관
    ...
    def transform(self, data):
        ...
        for row in data: # [12, 25, 37], [15, 27, 30], [16, 30, 45]
            new_row = []
            for i, value in enumerate(row): # [12, 25, 37]
